...
\newcommand{\hmwkTitle}{On the Quadratic Residue Theorem}
...
\begin{titlepage}
	...
	\vspace{1cm}
	{\scshape\Large Quadratic Residue Theorem\par}
	\vspace{1.5cm}
...
\begin{abstract}
In this paper we will discuss quadratic reciprocity and 
\end{abstract}
